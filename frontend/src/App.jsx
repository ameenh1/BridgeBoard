...
function Login({ onLogin }) {
  return <main className="login-page"><section className="intro-panel"><LeafDecor /><div className="brand-lockup"><h1>Bridge<br />Board</h1><p>An AI-powered AAC Board</p></div><div className="kids"><img className="kids-art" src={kids} alt="Two children using communication devices" /></div></section><section className="feature-panel"><form className="login-form" onSubmit={onLogin}><h2>Welcome Back, Cha</h2><p>Sign in to access your communication board</p><label htmlFor="email">Email</label><input id="email" type="email" placeholder="you@example.com" required /><div className="password-heading"><label htmlFor="password">Password</label><a href="#forgot-password">Forgot password?</a></div><input id="password" type="password" placeholder="Enter your password" required /><button className="continue-button" type="submit">Continue</button><div className="form-divider"><span>or</span></div><button className="google-button" type="button">Continue with Google</button><p className="signup-prompt"><span className="signup-copy">Don&apos;t have an account?</span> <a className="sign-up-link" href="#sign-up">Sign up</a></p></form></section></main>
}
